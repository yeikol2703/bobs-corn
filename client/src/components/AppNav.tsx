    ...
    <header className="sticky top-0 z-10 shrink-0 w-full bg-white border-b border-gray-200 shadow-sm">
      <div className="px-16 py-3 sm:py-4 flex flex-wrap items-center justify-between md:justify-start md:gap-4">
        ...
        >
          ...
          <a href="https://drive.google.com/drive/folders/1B_--bd-Gq41uqYLij0-cjrxIz4OCQ-Iq?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 font-medium text-sm py-3 md:py-0 border-b border-gray-100 last:border-b-0 md:border-b-0" onClick={() => setMenuOpen(false)}>
            Documentation
          </a>
        </nav>
